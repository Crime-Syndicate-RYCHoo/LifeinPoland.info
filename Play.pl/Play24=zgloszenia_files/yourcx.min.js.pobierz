...
*/
(function(){if(_undef(window.yourcx)||typeof window.yourcx!="function"){window.yourcx=undefined;(function(y,o,u,r,c,x){y[c]=y[c]||function(){(y[c].q=y[c].q||[]).push(arguments)};if(x){if(typeof y[x]!="undefined"&&typeof y[x].q!="undefined")for(var i=0;i<y[x].q.length;i++)y[c].apply(null,y[x].q[i]);y[x]=y[c]}})(window,document,"script",".","yourcx","opiniac")}if(_undef(window.opiniac))(function(y,o,u,r,c,x){y[x]=y[c]})(window,document,"script",".","yourcx","opiniac");if(_undef(window.yourcx.loaded))window.yourcx.loaded=true;else return;if(_undef(window.yourcx.q))window.yourcx.q=[];var _config={products:{acceptable:["audit","checkout","quit","target","insert"],exclusive:["audit"],multiply:["insert","target"]},geolocation:{check:false},pageTypeFunc:function(pageType){},charEncodingTranslate:function(txt){return txt},analytics:{pathDimensions:["page.type","page.type_path"],processDimensionsFunc:function(key,val){},defaultParams:{session:{"user.logged":false},visitor:{"user.customer":false},events:{}},flags:{monitorHashChange:false,monitorHistoryChange:true,hashHistoryChangeAutoClean:true,hashHistoryChangeAutoRepeat:false,paths:true,events:true}},plugins:{},allowedSurveys:["08f90c1a417155361a5c4b8d297e0d78","630e096226665f92720b4b08189540ee","9922f5774d88b203c4ec0fdd26616899","3fd60983292458bf7dee75f12d5e9e05","fc325d4b598aaede18b53dca4ecfcb9c","ba144d211d9cc67d38b79d05be77af3b","a5a7a33e1364df08664b544a5eee7e57","2c7b71beb6f21424052f6aefacd48b2c","17f98ddf040204eda0af36a108cbdea4","5ac8bb8a7d745102a978c5f8ccdb61b8","8879a98256ed4593d61de9cdcee35e10","2650d6089a6d640c5e85b2b88265dc2b","b628386c9b92481fab68fbf284bd6a64","b31df16a88ce00fed951f24b46e08649","1c303b0eed3133200cf715285011b4e4","ade55409d1224074754035a5a937d2e0","e37b08dd3015330dcbb5d6663667b8b8","cdcb2f5c7b071143529ef7f2705dfbc4","ddd616c540d241f97c0000cff07d1a52","46515dcd99ea50dd0671bc6840830404","8a20a8621978632d76c43dfd28b67767","c429429bf1f2af051f2021dc92a8ebea"]};var _defaultSurveyConfig={};var _defaultProductConfig={};var _surveyPreRunCheck={};var _surveys={},_surveysByProducts={},_observer=new Observers,_mutationObserver=new MutationObservers(_observer),_arrayObserver=new ArrayObserver(_observer),_run_time=(new Date).getTime(),_storage=null,_analytics=null,_tablet=_detectMobile().tablet,_mobile=_detectMobile().phone,_clientId=90,_logging=false,_globalFireSurveyBlock=false,_globalWelcomeBlock=false,_postponedSurveys={};function fExtend(out){out=out||{};for(var i=1;i<arguments.length;i++){var obj=arguments[i];if(!obj)continue;for(var key in obj){if(obj.hasOwnProperty(key)){if(obj[key]===Object(obj[key])&&typeof obj[key]!="function"){if(out[key]!==Object(out[key]))out[key]={};out[key]=fExtend(out[key],obj[key])}else out[key]=obj[key]}}}return out}function _undef(a){return typeof a=="undefined"}function _pluginRegister(obj){for(var i=0;i<obj.config.events.length;i++){switch(obj.config.events[i]){case"receiveResult":_observer.on(obj.config.events[i],function(x){return function(data){var name=obj.config.name;if(!_undef(data.rules[name]))obj["on"+x](data.results,data.rules[name])}}(obj.config.events[i]));break;default:_observer.on(obj.config.events[i],function(x){return function(data){obj["on"+x](data)}}(obj.config.events[i]));break}}}function _detectMobile(){var apple_phone=/iPhone/i,apple_ipod=/iPod/i,apple_tablet=/iPad/i,android_phone=/(?=.*\bAndroid\b)(?=.*\bMobile\b)/i,android_tablet=/Android/i,amazon_phone=/(?=.*\bAndroid\b)(?=.*\bSD4930UR\b)/i,amazon_tablet=/(?=.*\bAndroid\b)(?=.*\b(?:KFOT|KFTT|KFJWI|KFJWA|KFSOWI|KFTHWI|KFTHWA|KFAPWI|KFAPWA|KFARWI|KFASWI|KFSAWI|KFSAWA)\b)/i,windows_phone=/Windows Phone/i,windows_tablet=/(?=.*\bWindows\b)(?=.*\bARM\b)/i,other_blackberry=/BlackBerry/i,other_blackberry_10=/BB10/i,other_opera=/Opera Mini/i,other_chrome=/(CriOS|Chrome)(?=.*\bMobile\b)/i,other_firefox=/(?=.*\bFirefox\b)(?=.*\bMobile\b)/i,seven_inch=new RegExp("(?:"+"Nexus 7"+"|"+"BNTV250"+"|"+"Kindle Fire"+"|"+"Silk"+"|"+"GT-P1000"+")","i");var match=function(regex,userAgent){return regex.test(userAgent)};var IsMobileClass=function(userAgent){var ua=userAgent||navigator.userAgent;var tmp=ua.split("[FBAN");if(typeof tmp[1]!=="undefined"){ua=tmp[0]}tmp=ua.split("Twitter");if(typeof tmp[1]!=="undefined"){ua=tmp[0]}this.apple={phone:match(apple_phone,ua),ipod:match(apple_ipod,ua),tablet:!match(apple_phone,ua)&&match(apple_tablet,ua),device:match(apple_phone,ua)||match(apple_ipod,ua)||match(apple_tablet,ua)};this.amazon={phone:match(amazon_phone,ua),tablet:!match(amazon_phone,ua)&&match(amazon_tablet,ua),device:match(amazon_phone,ua)||match(amazon_tablet,ua)};this.android={phone:match(amazon_phone,ua)||match(android_phone,ua),tablet:!match(amazon_phone,ua)&&!match(android_phone,ua)&&(match(amazon_tablet,ua)||match(android_tablet,ua)),device:match(amazon_phone,ua)||match(amazon_tablet,ua)||match(android_phone,ua)||match(android_tablet,ua)};this.windows={phone:match(windows_phone,ua),tablet:match(windows_tablet,ua),device:match(windows_phone,ua)||match(windows_tablet,ua)};this.other={blackberry:match(other_blackberry,ua),blackberry10:match(other_blackberry_10,ua),opera:match(other_opera,ua),firefox:match(other_firefox,ua),chrome:match(other_chrome,ua),device:match(other_blackberry,ua)||match(other_blackberry_10,ua)||match(other_opera,ua)||match(other_firefox,ua)||match(other_chrome,ua)};this.seven_inch=match(seven_inch,ua);this.any=this.apple.device||this.android.device||this.windows.device||this.other.device||this.seven_inch;this.phone=this.apple.phone||this.android.phone||this.windows.phone;this.tablet=this.apple.tablet||this.android.tablet||this.windows.tablet;if(typeof window==="undefined"){return this}};var IM=new IsMobileClass;IM.Class=IsMobileClass;return IM}function _out(txt){txt=_config.charEncodingTranslate(txt);return txt}function _log(msg){if(!_logging)return;var a=document.getElementById("yourcx.log");if(!a){a=document.createElement("div");a.setAttribute("id","yourcx.log");document.body.appendChild(a)}var err=new Error;a.innerHTML=a.innerHTML+"<br />"+(new Date).getTime()+" "+msg+"<br />"+err.stack}var _generateGUID=typeof window.crypto!="undefined"&&typeof window.crypto.getRandomValues!="undefined"?function(){var buf=new Uint16Array(8);window.crypto.getRandomValues(buf);var S4=function(num){var ret=num.toString(16);while(ret.length<4){ret="0"+ret}return ret};return S4(buf[0])+S4(buf[1])+"-"+S4(buf[2])+"-"+S4(buf[3])+"-"+S4(buf[4])+"-"+S4(buf[5])+S4(buf[6])+S4(buf[7])}:function(){return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(c){var r=Math.random()*16|0,v=c=="x"?r:r&3|8;return v.toString(16)})};var _cookie={set:function(e,t,n,r,i,s){var o=e+"="+escape(t);if(n){var u=new Date;var a=new Date(u.getTime()+n*1e3*60);o+="; expires="+a.toGMTString()}if(r)o+="; path="+escape(r);if(i)o+="; domain="+escape(i);if(s)o+="; secure";document.cookie=o;return this},get:function(e){var t=document.cookie.match("(^|;) ?"+e+"=([^;]*)(;|$)");if(t)return unescape(t[2]);else return null}};var _misc={};_misc.url={getQueryStringObj:function(query){if(typeof query=="undefined")query=document.location.search;var obj={},qPos=query.indexOf("?"),tokens=query.substr(qPos+1).split("&"),i=tokens.length-1;if(qPos!==-1||query.indexOf("=")!==-1){for(;i>=0;i--){var s=tokens[i].split("=");obj[unescape(s[0])]=s.hasOwnProperty(1)?unescape(s[1]):null}}return obj}};_config.analytics.flags.paths = true;
_config.analytics.flags.events = true;
_config.analytics.flags.monitorHashChange = false;
_config.analytics.flags.monitorHistoryChange = true;

function _runConfigAndConditions(){
 _defaultProductConfig['quit'] = {"config":{"methods":{"noMouseMoveOut":{"enabled":true,"delay":5,"minTimeWithoutMovement":10,"probability":1},"timeOnPageOut":{"enabled":true,"minTimeOnPage":15,"maxTimeOnPage":400,"probability":1},"noScrollTouchOut":{"enabled":true,"probability":1}},"display":{"minHeight":620},"surveyDelay":0.4,"postpone":{"enable":false,"maxPostponeMinutes":360,"methods":{"widget":{"enable":true}}},"mouse":{"speed":{"minSpeed":500}}}};

 _defaultProductConfig['audit'] = {"surveyMode":"layer","linkText":"Oce\u0144 stron\u0119","skin":"c0","config":{"pictogramMode":"right","display":{"minHeight":620},"pictogramTemplate":"\/\/static.yourcx.io\/customers\/90\/logo.png"},"od":{"skins":{"c0":{"a":{"c":"#ffffff","ba":"#6C43BF","bo":"#6C43BF"},"p":"_navyblue","s":null,"ah":{"c":"#6C43BF","ba":"#ffffff","bo":"#6C43BF"},"as":"div#yourcx_blk img { transform: rotate(90deg); width: 36px; height: 36px; padding: 2px; background-color: #ffffff; display: none; }\ndiv#yourcx_blk a.link { padding: 6px 12px 6px 12px; border-width: 2px; transition: background .3s; font-family: Manrope; }\ndiv#yourcx_blk { top: 50%; }"},"c1":{"a":{"c":"#ffffff","ba":"#5c2295","bo":"#5c2295"},"p":"\/\/static.yourcx.io\/yourcx\/yourcx.audit_magenta.gif","s":null,"ah":{"c":"#5c2295","ba":"#ffffff","bo":"#5c2295"},"as":"div#yourcx_blk img { transform: rotate(90deg); width: 36px; height: 36px; padding: 2px; background-color: #ffffff; display: none; }\ndiv#yourcx_blk a.link { border-width: 2px; transition: background .3s; font-family: Manrope; padding: 6px 12px 6px 12px }\n#yourcx_layer { z-index: 2147483648 !important; }\ndiv#yourcx_blk { top: 60%; }"},"c2":{"a":{"c":"#ffffff","ba":"#5c2295","bo":"#5c2295"},"p":"_navyblue","s":null,"ah":{"c":"#5c2295","ba":"#ffffff","bo":"#5c2295"},"as":"div#yourcx_blk img { width: 36px; height: 36px; padding: 2px; background-color: #ffffff; }\ndiv#yourcx_blk a.link { padding: 2px 2px 2px 12px; border-width: 2px; transition: background .3s; }\ndiv#yourcx_blk a.cls { background-color: #ffffff; line-height: 10px; border-radius: 6px; border: 2px solid #555555; position: absolute; top: -20px; right: 0px; padding: 2px; }\ndiv#yourcx_blk > div { background-color: unset; position: relative; }\n#yourcx_corner.pmr { z-index: 2147483640; }\ndiv#yourcx_blk a.cls svg { fill: #555555; width: 14px; height: 14px; }"}}}};

 _defaultProductConfig['target'] = {"config":{"probability":0.2,"prerequisites":{"minTimeOnSite":33},"minPages":{"enabled":true,"pageNum":6},"display":{"minHeight":620},"welcome":{"style":{"width":0}},"postpone":{"enable":true,"maxPostponeMinutes":360,"globalMode":true,"blockade":"afterSurveyFilled","allowWelcomeForPostponed":false,"methods":{"quit":{"enable":true},"widget":{"enable":true,"verticalMode":"top","style":{"sideMargin":0,"body":{"bg":"#583787","padding":"2px"},"button":{"c":"#ffffff","bg":"#583787"}},"buttons":{"1":{"text":"Doko\u0144cz ankiet\u0119 >>"}}}}}}};

 _defaultProductConfig['checkout'] = {"config":{"methods":{"autoWelcome":{"enabled":true,"delaySeconds":600,"probability":0},"timeOnPageOut":{"enabled":true,"minTimeOnPage":20,"maxTimeOnPage":500,"probability":0.6},"notProcessPage":{"enabled":true,"delaySeconds":0,"pageNum":6,"probability":0}},"display":{"minHeight":640}}};

 _config.plugins['yourcx.invoke.livechatinc'] = [];

 _config.plugins['yourcx.integrate.ga'] = {"mode":"pushDataLayer","modeConfig":{"pushDataLayer":{"send":"individual"}}};
var _randomNumberForTriggerSet = Math.random();

_defaultSurveyConfig['8879a98256ed4593d61de9cdcee35e10'] = fExtend(_defaultSurveyConfig['8879a98256ed4593d61de9cdcee35e10'], {"target":{"surveyMode":"window","config":{"probability":0.33,"prerequisites":{"minTimeOnSite":0},"minPages":{"enabled":false,"pageNum":0},"welcome":{"enable":true,"submode":"left","followUser":{"enable":true},"addFooter":false,"style":{"addCss":"#yourcx_layer_welcome .yourcx_welcome_close { display: none; }\r\n#yourcx_layer_welcome .yourcx_welcome_head { display: none; }\r\n#yourcx_layer_welcome .yourcx_welcome_main { box-shadow: none; border: none; background-color: rgba(15, 62, 25, 0.88); }\r\n#yourcx_layer_welcome .yourcx_welcome_body { display: flex; background-color: transparent; color: #ffffff; padding: 20px; }\r\n#yourcx_layer_welcome .yourcx_welcome_body_in { padding: 20px; text-align: left; }\r\n#yourcx_layer_welcome .yourcx_welcome_body_in1 { font-size: 20px; font-weight: bold; margin-bottom: 10px; }\r\n#yourcx_layer_welcome .yourcx_welcome_body_in2, #yourcx_layer .yourcx_welcome_body_in2 { font-size: 13px; }\r\n#yourcx_layer_welcome .yourcx_welcome_buttons { flex-direction: column; padding-top: 10px; }\r\n#yourcx_layer_welcome .yourcx_welcome_button { white-space: nowrap; }\r\n#yourcx_layer_welcome .yourcx_welcome_button.yourcx_welcome_button1 { background: #ffffff; color: #222222; min-width: 170px; padding: 15px; margin-right: 0px; }\r\n#yourcx_layer_welcome .yourcx_welcome_button.yourcx_welcome_button1:hover { background: #eeeeee; }\r\n#yourcx_layer_welcome .yourcx_welcome_button.yourcx_welcome_button2 { text-decoration: underline; background: transparent; color: #ffffff; padding: 15px; font-size: 13px; }\r\n#yourcx_layer_welcome .yourcx_welcome_button.yourcx_welcome_button2:hover { text-decoration: none; }\r\n#yourcx_layer_welcome .yourcx_welcome_mobile .yourcx_welcome_body { padding: 5px; }\r\n#yourcx_layer_welcome .yourcx_welcome_mobile .yourcx_welcome_button.yourcx_welcome_button1 { min-width: 120px; }\r\n"},"texts":{"main":"<div class=\"$CLASSBASE$body_in\"><div class=\"$CLASSBASE$body_in1\">Witaj,<\/div><div class=\"$CLASSBASE$body_in2\">Czy mo\u017cesz nam pom\u00f3c ulepszy\u0107 nasz serwis?<\/div><div class=\"$CLASSBASE$body_in3\">Ankieta zajmie kilka sekund.<\/div><\/div>","buttons":"<div class=\"$CLASSBASE$buttons\">\n      <a class=\"$CLASSBASE$button $CLASSBASE$button1\"><\/a>\n      <a class=\"$CLASSBASE$button $CLASSBASE$button2\"><\/a>\n    <\/div>"},"buttons":{"1":{"text":"Jasne, rozpocznij!"},"2":{"text":"Przykro mi, nie mog\u0119!"}}},"blockDaysAfterSurveyShown":{"survey":3,"allSurveys":1}}}});

_defaultSurveyConfig['ba144d211d9cc67d38b79d05be77af3b'] = fExtend(_defaultSurveyConfig['ba144d211d9cc67d38b79d05be77af3b'], {"target":{"config":{"probability":0.84,"prerequisites":{"minTimeOnSite":35},"minPages":{"enabled":true,"delaySeconds":30,"pageNum":2}}}});

_defaultSurveyConfig['ba144d211d9cc67d38b79d05be77af3b'] = fExtend(_defaultSurveyConfig['ba144d211d9cc67d38b79d05be77af3b'], {"audit":{"surveyMode":"slide"}});

_defaultSurveyConfig['ddd616c540d241f97c0000cff07d1a52'] = fExtend(_defaultSurveyConfig['ddd616c540d241f97c0000cff07d1a52'], {"target":{"config":{"probability":0.19,"minPages":{"enabled":true,"pageNum":5}}}});

_defaultSurveyConfig['8879a98256ed4593d61de9cdcee35e10'] = fExtend(_defaultSurveyConfig['8879a98256ed4593d61de9cdcee35e10'], {"quit":{"config":{"methods":{"noMouseMoveOut":{"minTimeWithoutMovement":10,"probability":1},"timeOnPageOut":{"minTimeOnPage":10}},"blockDaysAfterSurveyShown":0,"blockades":{"product":{"set":false,"check":false}}}}});

_defaultSurveyConfig['2c7b71beb6f21424052f6aefacd48b2c'] = fExtend(_defaultSurveyConfig['2c7b71beb6f21424052f6aefacd48b2c'], {"target":{"config":{"probability":1}}});

_defaultSurveyConfig['17f98ddf040204eda0af36a108cbdea4'] = fExtend(_defaultSurveyConfig['17f98ddf040204eda0af36a108cbdea4'], {"target":{"config":{"probability":1,"prerequisites":{"minTimeOnSite":0},"minPages":{"enabled":false},"display":{"stickToTop":true,"minHeight":540},"welcome":{"enable":false},"blockades":{"mode":"individual"}}}});

_defaultSurveyConfig['b31df16a88ce00fed951f24b46e08649'] = fExtend(_defaultSurveyConfig['b31df16a88ce00fed951f24b46e08649'], {"target":{"config":{"probability":0.91,"prerequisites":{"minTimeOnSite":7},"minPages":{"enabled":true,"pageNum":2},"display":{"stickToTop":true,"minHeight":540},"welcome":{"enable":false},"postpone":{"enable":false},"blockades":{"product":{"set":true},"mode":"individual","surveys":{"daysAfterShown":3,"daysAfterFirstAnswer":21},"probabilityBlockMode":"visit"}}}});
var style = document.createElement('style')
style.setAttribute('type', 'text/css');
var s = '#yourcx_layer { z-index: 2147483648 !important; }';
...
/*
if ((_analytics.path.checkStep('url', 'last', /telefony\/retencja/)) &&
    (_analytics.path.checkStep('url', 'previous', /checkout2/)))
      yourcx('survey', '0a87257e5308197df43230edf4ad1dae', { product: 'target' } );
*/

if ((_analytics.path.checkStep('url', 'last', /checkout2/)) &&
    (_analytics.path.checkStep('url', 'previous', /checkout3/)))
      yourcx('run', 'a5a7a33e1364df08664b544a5eee7e57', { product: 'checkout' }, 'checkout3 to checkout2' );


if ((_analytics.path.checkStep('url', {type: 'first' }, /\/dlaciebie\/sklep\/telefony\/\?oid=4010164669/) !== false) ||
    (_analytics.path.checkStep('url', {type: 'first' }, /\/dlaciebie\/sklep\/telefony\/\?oid=4010164249/) !== false) ||
    (_analytics.path.checkStep('url', {type: 'first' }, /\/dlaciebie\/sklep\/telefony\/\?oid=4010164519/) !== false) ||
    (_analytics.path.checkStep('url', {type: 'first' }, /\/dlaciebie\/sklep\/telefony\/\?oid=4010164549/) !== false)) {
    _defaultSurveyConfig['8879a98256ed4593d61de9cdcee35e10']['target']['config']['probability'] = 1;
    _defaultSurveyConfig['8879a98256ed4593d61de9cdcee35e10']['target']['config']['prerequisites']['minTimeOnSite'] = 90;
}
/*
if (!_analytics.path.checkStep('url', 'last', /checkout2/) &&
    !_analytics.path.checkStep('url', 'last', /cart/) &&
    (_analytics.path.checkStep('url', 'previous', /play.pl\/oferta\/play-internet-tv/))) {
      yourcx('dimension', 'product.survey.invokemode', 'after product page');
      yourcx('survey', '4ea6a546c19499318091a9df40a13181', { product: 'target'});
    }
*/
if (_analytics.path.checkStep('url', 'last', /play.pl\/telefony\//))
  yourcx('dimension', 'product.page.version', 'old', 'session');

if (_analytics.path.checkStep('url', 'last', /dlaciebie\/produkty\//)) {
  yourcx('dimension', 'product.page.version', 'new', 'session');
  
  /*
  if (!_undef(_defaultSurveyConfig['a386b3ef5425051125c900d85489468f']['target']))
    _defaultSurveyConfig['a386b3ef5425051125c900d85489468f']['target']['config']['probability'] = 1;
  
  if (!_undef(_defaultSurveyConfig['a386b3ef5425051125c900d85489468f']['quit'])) {
    _defaultSurveyConfig['a386b3ef5425051125c900d85489468f']['quit']['config']['methods']['noMouseMoveOut']['probability'] = 1;
    _defaultSurveyConfig['a386b3ef5425051125c900d85489468f']['quit']['config']['methods']['timeOnPageOut']['probability'] = 1;
    _defaultSurveyConfig['a386b3ef5425051125c900d85489468f']['quit']['config']['methods']['noScrollTouchOut']['probability'] = 1;
  }
  */
}

if (_analytics.path.checkStep('url', 'last', /play.pl\/telefony\//) || _analytics.path.checkStep('url', 'last', /dlaciebie\/produkty\//)) {
  setTimeout(function() {
    yourcx('dimension', 'product.survey.invokemode', 'after time');
    yourcx('survey', 'a386b3ef5425051125c900d85489468f', { product: 'target'});
      
  }, 1000 * 100);
    
  yourcx('survey', 'a386b3ef5425051125c900d85489468f', { product: 'quit'});
}


/*
  // cenniki3x3
  var pos = _analytics.path.checkStep('url', {type: 'first' }, /\/oferta\/przejdz-do-play\/play-abonament/);
  if (pos) {
    var pos = _analytics.path.checkStep('url', {type: '>', start: pos }, /\/cart\/$/);
    if (pos && _analytics.path.checkStep('url', 'last', /\/dlaciebie\/sklep\/telefony\?bundleNo=2&oid=/)) {
      yourcx('survey', 'db9db3280de005ffedc448d12ea16a7d', { product: 'quit'});
    }
  }
*/
/*
if ((_analytics.path.checkStep('url', 'last', /\/dlaciebie\/sklep\/telefony\?bundleNo=2&oid=/)) &&
    (_analytics.path.checkStep('url', 'previous', /cart/)) &&
    (_analytics.path.checkStep('url', -2,  /\/oferta\/przejdz-do-play\/play-abonament/)))
      yourcx('survey', 'db9db3280de005ffedc448d12ea16a7d', { product: 'quit'});
*/

if (!_analytics.path.checkStep('url', 'last', /play.pl\/nowy\//) && !_analytics.path.checkStep('url', 'last', /play.pl\/$/)) {
  if (_analytics.path.checkStep('url', 'previous', /play.pl\/nowy\//)) {
    yourcx('dimension', 'page.version', 'new');
    
    // _defaultSurveyConfig['80a495b8c2b5d2bb9dad770cb4be3bbf']['target']["config"]["probability"] = 0.1;

    yourcx('survey', '80a495b8c2b5d2bb9dad770cb4be3bbf', { product: 'target'});
  }

//  if (_analytics.path.checkStep('url', 'previous', /play.pl\/$/)) {
//    yourcx('dimension', 'page.version', 'old');
//    yourcx('survey', '80a495b8c2b5d2bb9dad770cb4be3bbf', { product: 'target'});
//  }
}

_surveyPreRunCheck['ba144d211d9cc67d38b79d05be77af3b'] = function(surveyConfig){
if ( surveyConfig.product == 'audit' )
  return true;

if ( surveyConfig.product == 'target' )
  yourcx('survey', 'ba144d211d9cc67d38b79d05be77af3b', { product: 'audit', linkText: 'Oceń stronę'});

if (help_survey_block)
  return false;
...
var element = document.getElementById('yourcx_layer_postpone');
if (element)
  element.style.display = "none";
  
  var style = document.createElement('style')
  style.setAttribute('type', 'text/css');
  var s = 'div#yourcx_layer_postpone { display: none; }';
  if (style.styleSheet)
    style.styleSheet.cssText = s;
  else
    style.appendChild(document.createTextNode(s));
...
(function() {
  var elem = document.querySelector('header .v-navbar__multi-level-menu--login nav ul button span');
  if (!elem)
    return;

  var txt = elem.innerHTML.trim().replace(/(<([^>]+)>)/gi, "").trim();
  
//  console.log( txt );
  
  if (!txt){
    elem = document.querySelector('header div.v-navbar__mobile-bar div.v-navbar__login-menu-bottom-sheet button span');
    if (!elem)
      return;

    txt = elem.innerHTML.trim().replace(/(<([^>]+)>)/gi, "").trim();
  }
  
//  console.log( txt );
  
  var params = _analytics.getClientParams(null, true);
  
  if (typeof(params['use.home.logged']) == 'undefined')
    _analytics.addClientParam('use.home.logged', false, 'session');
  
  if (txt == 'Moje konto') {
    if ((typeof(params['use.home.logged']) != 'undefined') && !params['use.home.logged']) {
      _analytics.addClientParam('use.home.logged', true, 'session');
      
      // show survey only if logged to home page
      if ((document.location.pathname == '/nowy/') || (document.location.pathname == '/'))
        yourcx('survey', '17f98ddf040204eda0af36a108cbdea4', { product: 'target'});
    }
  }
 ...
 if((( _mobile === true))) 
 {
 fExtend(_defaultProductConfig['quit'], {"config":{"methods":{"noMouseMoveOut":{"enabled":true,"delay":5,"minTimeWithoutMovement":10,"probability":1},"timeOnPageOut":{"enabled":true,"minTimeOnPage":15,"maxTimeOnPage":400,"probability":1},"noScrollTouchOut":{"enabled":true,"probability":1}},"display":{"minHeight":540},"surveyDelay":0.4,"postpone":{"enable":false},"mouse":{"speed":{"minSpeed":500}}}});


_defaultSurveyConfig['8879a98256ed4593d61de9cdcee35e10'] = fExtend(_defaultSurveyConfig['8879a98256ed4593d61de9cdcee35e10'], {"target":{"config":{"probability":0.33}}});

_defaultSurveyConfig['ba144d211d9cc67d38b79d05be77af3b'] = fExtend(_defaultSurveyConfig['ba144d211d9cc67d38b79d05be77af3b'], {"audit":{"surveyMode":"layer"}});
fExtend(_defaultProductConfig['audit'], {"skin":"c1"});

fExtend(_defaultProductConfig['target'], {"config":{"postpone":{"globalMode":true,"methods":{"widget":{"style":{"addCss":"#yourcx_layer_postpone { width: 100%; right: 0px; }\n#yourcx_layer_postpone .yourcx_postpone_main { border: 0px; }\n#yourcx_layer_postpone .yourcx_postpone_button { font-weight: bold; }\n\n.container .yourcx_postpone_main { position: relative; top: -10px; text-align: center; }\n.container .yourcx_postpone_button { color: #ffffff; background: #583787; padding: 8px; }\n\n.sticky-summary .yourcx_postpone_main { text-align: center; }\n.sticky-summary .yourcx_postpone_buttons { margin: 10px; }\n.sticky-summary .yourcx_postpone_button { color: #ffffff; background: #583787; padding: 8px; }\n"}}},"display":{"changePostponedSurveyMode":true}}}});


(function() {
var elements = document.getElementsByClassName('sticky-summary');
if (!elements.length)
  return;
...
_observer.on('closePostponedWidget', function(surveyId) {
  var base = document.getElementsByClassName('yourcx_postpone_main');
...
var mutationCallback = function(mutation) {
  ...
  var contain = mutation.target.classList.contains("is-sticky");
  if (contain) {
    var base = document.getElementsByClassName('yourcx_postpone_main');
    if (base.length)
      mutation.target.prepend(base[0]);
  } else {
    var base = document.getElementsByClassName('yourcx_postpone_main');
    if (base.length)
      document.getElementById('yourcx_layer_postpone').prepend(base[0]);
  }
}
    
_mutationObserver.observe('phone_price', element, mutationCallback);
})();
if (document.location.hash == '#yourcx') {
  yourcx('forcerun', '8879a98256ed4593d61de9cdcee35e10', { product: 'target' });
}

}


 if(((document.location.href.match(/^https\:\/\/nowy\.play\.pl\/cart\/$/))) || ((document.location.href.match(/^https\:\/\/nowy\.play\.pl\/cart$/)))) 
 {
 
(function() {
var elements = document.getElementsByTagName('common-modal-component');
if (!elements.length)
  return;
...
var inited = false;
var addedEvent1 = false;
var addedEvent2 = false;
...
var mutationCallback = function(mutation) {
  if (!inited) {
    ...
    setTimeout(function() {
      ...
      var el = document.getElementById('number-verification-sms');
      if (!el) {
        return;
      }
      
      var tags = el.getElementsByTagName('button');
      for (var tag of tags) {
        if (tag.getAttribute('data-automation-id') == 'multisim-mnp-popup-close') {
          if (!addedEvent1) {
            tag.addEventListener('click', function () {
              // console.log( 'clicked1' );
              yourcx('forcerun', '46515dcd99ea50dd0671bc6840830404', { product: 'target' });
            });
            addedEvent1 = true;
          }
        }
    ...
    setTimeout(function() {
      ...
      var el = document.getElementById('number-verification');
      if (!el) {
        return;
      }
...
_mutationObserver.observe('mnp modal', element, mutationCallback, { subtree: true, attributes: true, childList: true, characterData: true });
})();
}


 if(((document.location.href.match(/^https\:\/\/nowy\.play\.pl\/cart\/$/)) && ( _mobile === true)) || ((document.location.href.match(/^https\:\/\/nowy\.play\.pl\/cart$/)) && ( _mobile === true))) 
 {
 (function() {
  
var attachToImage = function() {
  var elems = document.getElementsByClassName('cart-item-device-element');
  
  for (var elem of elems) {
    var innerElems = elem.getElementsByClassName('device-img');
    
    for (var innerElem of innerElems) {
      innerElem.addEventListener('click', function () {
        // console.log( 'clicked1' );
        yourcx('run', '8a20a8621978632d76c43dfd28b67767', { product: 'target' });
      });
    }
  }
};

setTimeout(attachToImage, 10);
})();



_defaultSurveyConfig['8a20a8621978632d76c43dfd28b67767'] = fExtend(_defaultSurveyConfig['8a20a8621978632d76c43dfd28b67767'], {"target":{"config":{"blockades":{"mode":"individual"}}}});
}


 if(((document.location.href.match(/play\.pl\/oferta\/play\-internet\-tv/)))) 
 {
 
_defaultSurveyConfig['3fd60983292458bf7dee75f12d5e9e05'] = fExtend(_defaultSurveyConfig['3fd60983292458bf7dee75f12d5e9e05'], {"target":{"config":{"probability":0.99,"minPages":{"enabled":true,"delaySeconds":200,"pageNum":0}}}});

yourcx('survey', '3fd60983292458bf7dee75f12d5e9e05', { product: 'audit' });

yourcx('survey', '3fd60983292458bf7dee75f12d5e9e05', { product: 'target' });
}


 if(((document.location.href.match(/https\:\/\/www\.play\.pl\/oferta\/play\-internet\/internet\-swiatlowodowy/)) && (document.location.href.match(/^((?!https\:\/\/www\.play\.pl\/oferta\/play\-internet\/internet\-swiatlowodowy\/wi\-fi\-mesh).)*$/)))) 
 {
 
_defaultSurveyConfig['9922f5774d88b203c4ec0fdd26616899'] = fExtend(_defaultSurveyConfig['9922f5774d88b203c4ec0fdd26616899'], {"target":{"config":{"probability":0.99,"minPages":{"enabled":true,"delaySeconds":150,"pageNum":0}}}});

yourcx('survey', '9922f5774d88b203c4ec0fdd26616899', { product: 'audit' });

yourcx('survey', '9922f5774d88b203c4ec0fdd26616899', { product: 'target' });
}


 if(((document.location.href.match(/play\.pl\/oferta\/play\-abonament\/nowy\-numer/))) || ((document.location.href.match(/play\.pl\/oferta\/play\-abonament\/przenies\-numer/))) || ((document.location.href.match(/play\.pl\/oferta\/play\-abonament\/przejdz\-na\-abonament/)))) 
 {
 
_defaultSurveyConfig['fc325d4b598aaede18b53dca4ecfcb9c'] = fExtend(_defaultSurveyConfig['fc325d4b598aaede18b53dca4ecfcb9c'], {"target":{"config":{"probability":0.99,"minPages":{"enabled":true,"delaySeconds":100,"pageNum":0}}}});

yourcx('survey', 'fc325d4b598aaede18b53dca4ecfcb9c', { product: 'audit' });

yourcx('survey', 'fc325d4b598aaede18b53dca4ecfcb9c', { product: 'target' });
}

1==1}_observer.on("runSurveys",_runConfigAndConditions);_observer.on('runSurveys', function() {
_observer.on('welcome.show', function(surveyId) {
  _observer.fire('gaDataLayerPush', { 'event':'yourcx-invitation-show', 'yourcx-survey' : 'Badanie ogólne 2020'});
});

_observer.on('postponeSurvey', function(surveyId) {
  _observer.fire('gaDataLayerPush', { 'event':'yourcx-survey-postpone', 'yourcx-survey' : 'Badanie ogólne 2020'});
  yourcx('event', 'postponeSurvey', surveyId, 'session');
});

_observer.on('runPostponedSurvey', function(surveyId) {
  _observer.fire('gaDataLayerPush', { 'event':'yourcx-survey-postpone-restore', 'yourcx-survey' : 'Badanie ogólne 2020'});
  yourcx('event', 'runPostponedSurvey', surveyId, 'session');
});

var initedPostponedSurvey = false;

_observer.on('initPostponedSurvey', function(surveyId) {
  var analyticsData = _analytics.getData();
  
  if (initedPostponedSurvey)
    return;
  
  if (!_undef(analyticsData.visit.page) && !_undef(_postponedSurveys[ surveyId ].page)) {
    if (analyticsData.visit.page - _postponedSurveys[ surveyId ].page > 3) {
      initedPostponedSurvey = true;
      yourcx('event', 'initPostponedSurvey', { hash: surveyId, mode: 'pages' }, 'session');
      yourcx('forcerun', '8879a98256ed4593d61de9cdcee35e10', { product: 'target' });
      return;
    }
  }
  ...
  if (!_undef(_postponedSurveys[ surveyId ].time)) {
    if (time - _postponedSurveys[ surveyId ].time > 180 * 1000) {
      initedPostponedSurvey = true;
      yourcx('event', 'initPostponedSurvey', { hash: surveyId, mode: 'time' }, 'session');
      yourcx('forcerun', '8879a98256ed4593d61de9cdcee35e10', { product: 'target' });
      return;
    }
  }
  
  console.log('initPostponedSurvey', analyticsData.visit.page - _postponedSurveys[ surveyId ].page, time - _postponedSurveys[ surveyId ].time);
});


/*
_observer.on('analytics.visit.new', function(_data) {
  if ((_data.diffSeconds > 3600) && (_data.diffSeconds < 86400))
    if (Math.random() < 0.05)
      yourcx('run', '99284750cddc19cfb016e7acdb89d1fe', { product: 'target', surveyMode: 'window', mode: 'left' });
});
*/
});
...
*/
function YourcxPluginInvokeLivechatInc(){this.config={name:"yourcx.invoke.livechatinc",events:["runSurveys"]};var _attributesDefault={visitorId:null,chat:{id:null,inQueue:false,waitTime:0,messagesCount:0,time:{windowOpened:null,chatStarted:null,chatEnded:null}},agent:{name:"",login:""}},_pluginConfigDefault={autoMinimizeWindow:false,surveyConfig:{product:"target"},probability:100,preStartSurveyCheck:function(startUrl,attributes){return true}};var _attributes=_attributesDefault,_pluginConfig=_pluginConfigDefault,that=this,timers={minimize:null,opened:null},surveyStarted=false,od={functions:{}};this.onrunSurveys=function(){if(_undef(_config.plugins)||_undef(_config.plugins[this.config.name])||_undef(_config.plugins[this.config.name].surveyId))return;_pluginConfig=fExtend(_pluginConfig,_config.plugins[this.config.name]);window.LC_API=window.LC_API||{};od.functions["on_chat_window_opened"]=LC_API.on_chat_window_opened;od.functions["on_chat_window_minimized"]=LC_API.on_chat_window_minimized;od.functions["on_chat_started"]=LC_API.on_chat_started;od.functions["on_chat_ended"]=LC_API.on_chat_ended;od.functions["on_message"]=LC_API.on_message;LC_API.on_chat_window_opened=function(){if(od.functions["on_chat_window_opened"]&&typeof od.functions["on_chat_window_opened"]=="function")od.functions["on_chat_window_opened"]();var visitor_id=LC_API.get_visitor_id();var chat_id=LC_API.get_chat_id();var startUrl=sessionStorage.getItem("yourcx.livechat start url");if(!startUrl)sessionStorage.setItem("yourcx.livechat start url",document.location.href);if(chat_id)_attributes.chat.id=chat_id;else{_attributes=_attributesDefault;timers.opened=setInterval(function(){_attributes.chat.inQueue=LC_API.visitor_queued();if(_attributes.chat.inQueue){window.clearInterval(timers.opened);timers.opened=null}},2500)}if(visitor_id)_attributes.visitorId=visitor_id;_attributes.chat.time.windowOpened=(new Date).getTime()};LC_API.on_chat_window_minimized=function(){if(od.functions["on_chat_window_minimized"]&&typeof od.functions["on_chat_window_minimized"]=="function")od.functions["on_chat_window_minimized"]();if(timers.minimize){window.clearTimeout(timers.minimize);timers.minimize=null}if(timers.opened){window.clearInterval(timers.opened);timers.opened=null}if(_attributes.chat.time.chatEnded)setTimeout(function(){that.startSurvey()},1e3)};LC_API.on_chat_started=function(data){if(od.functions["on_chat_started"]&&typeof od.functions["on_chat_started"]=="function")od.functions["on_chat_started"](data);var chat_id=LC_API.get_chat_id();if(timers.opened){window.clearInterval(timers.opened);timers.opened=null}if(chat_id&&!_attributes.chatId)_attributes.chat.id=chat_id;if(!_undef(data.agent_name))_attributes.agent.name=data.agent_name;_attributes.chat.time.chatStarted=(new Date).getTime();if(_attributes.chat.inQueue){_attributes.chat.waitTime=_attributes.chat.time.chatStarted-_attributes.chat.time.windowOpened}};LC_API.on_chat_ended=function(){if(od.functions["on_chat_ended"]&&typeof od.functions["on_chat_ended"]=="function")od.functions["on_chat_ended"]();_attributes.chat.time.chatEnded=(new Date).getTime();yourcx("event","","livechat.chat_ended","visitor");if(_pluginConfig.autoMinimizeWindow)timers.minimize=setTimeout(function(){LC_API.minimize_chat_window()},1e3)};LC_API.on_message=function(data){if(od.functions["on_message"]&&typeof od.functions["on_message"]=="function")od.functions["on_message"](data);++_attributes.chat.messagesCount;if(!_undef(data["user_type"])&&data["user_type"]=="agent")if(!_undef(data["agent_login"]))_attributes.agent.login=data["agent_login"]}};this.objectTreeToFlat=function(_obj,_flat,_baseKey){Object.keys(_obj).forEach(function(key,idx){var k=_baseKey+"."+key;if(_obj[key]===Object(_obj[key]))that.objectTreeToFlat(_obj[key],_flat,k);else _flat[_baseKey+"."+key]=_obj[key]})};this.startSurvey=function(){var surveyId=_pluginConfig.surveyId;var surveyConfig=_pluginConfig.surveyConfig;var dimensions={};var startUrl=sessionStorage.getItem("yourcx.livechat start url");if(surveyStarted)return;if(Math.random()*100>_pluginConfig.probability)return;if(_attributes.chat.messagesCount<2)return;if(!_pluginConfig.preStartSurveyCheck(startUrl,_attributes))return;surveyStarted=true;sessionStorage.removeItem("yourcx.livechat start url");this.objectTreeToFlat(_attributes,dimensions,"livechat");Object.keys(dimensions).forEach(function(key,idx){yourcx("dimension",key,dimensions[key])});yourcx("dimension","livechat.start.url",startUrl);if(!surveyId)return;yourcx("survey",surveyId,surveyConfig);setTimeout(function(){_surveys[surveyId][surveyConfig.product][0].fireSurveyInternal()},200)}}_yourcxPluginInvokeLivechatInc=new YourcxPluginInvokeLivechatInc;_pluginRegister(_yourcxPluginInvokeLivechatInc);
